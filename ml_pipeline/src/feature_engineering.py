...
class FeatureEngineer:
    ...
    def fit_transform(self, X_train, X_test=None):
        ...
        print(f"[OK] TF-IDF shape: {X_train_tfidf.shape}")
        ...
        print(f"[OK] PCA shape: {X_train_pca.shape}")
        print(f"[OK] Explained variance: {self.pca.explained_variance_ratio_.sum():.4f}")
    ...
    def save_transformers(self, tfidf_path: str, pca_path: str):
        ...
        print(f"[OK] Saved TF-IDF to {tfidf_path}")
        print(f"[OK] Saved PCA to {pca_path}")
